...
ADJ_FILE_PATH = os.path.join(DATA_ROOT, DATA_NAME, "adj_mx.pkl")
...
adj_mx, _ = load_adj(ADJ_FILE_PATH, "doubletransition")


CFG = EasyDict()
CFG.DESCRIPTION = (
    "Graph WaveNet on the TraffiDent D5 2023Q1 post-incident forecasting reproduction. "
    "The dataset is the official-script/all-classes BasicTS adapter slice; this config "
    "keeps the same 12-to-12 split and post-incident evaluation protocol as AGCRN."
)
CFG.GPU_NUM = 1
