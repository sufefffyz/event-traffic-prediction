...
class STIDAccident(nn.Module):
    """STID with one binary incident/accident embedding."""
    ...
    def __init__(self, **model_args):
        ...
        self.if_accident = model_args.get("if_accident", True)
        ...
        self.hidden_dim = (
            ...
            + self.accident_dim * int(self.if_accident)
        )
    ...
    def forward(
        ...
        **kwargs,
        ...
        if self.if_accident:
            ...
            acc_emb.append(self.accident_emb(accident_active).transpose(1, 2).unsqueeze(-1))

        hidden = torch.cat([time_series_emb] + node_emb + tem_emb + acc_emb, dim=1)
