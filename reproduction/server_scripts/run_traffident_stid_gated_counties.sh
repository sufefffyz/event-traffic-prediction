...
for county in "${county_array[@]}"; do
  cfg="baselines/STIDGatedAccident/TraffiDent_${county}.py"
  run_name="traffident_STIDGatedAccident_${county}_${TRAFFIDENT_NUM_EPOCHS}ep_g${GPU_ID}"
...
echo "[$(timestamp)] All TraffiDent STIDGatedAccident county jobs finished."
